...
namespace Registration.API.Controllers.V1
{   
    ...
    public class StudentController : ControllerBase
    {
        ...
        [HttpGet("{id}")]
        [ProducesResponseType<ServiceResponse<string>>(StatusCodes.Status200OK)]
        ...
        [ProducesResponseType<ServiceResponse<object>>(StatusCodes.Status200OK)]
