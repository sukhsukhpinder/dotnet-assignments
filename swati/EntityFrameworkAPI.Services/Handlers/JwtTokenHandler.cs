...
namespace EntityFrameworkAPI.Services.Handlers
{
    public class JwtTokenHandler
    {
        ...
        public async Task<AuthenticationResponse> GenerateJwtToken(AuthenticationRequest authenticationRequest, dynamic response)
        {
            ...
            if (response == null) { response = GetStudent(authenticationRequest); if (response == null) { return null; } }
            ...
            var securityTokenDescriptor = new SecurityTokenDescriptor
            {
                ...
                Expires = tokenExpiry, //,DateTime.UtcNow.AddDays(1),
            ...
            response.JwtToken = jwtSecurityTokenHandler.WriteToken(securityToken);

            response.ExpiresIn = (int)tokenExpiry.Subtract(DateTime.Now).Minutes;
        ...
        /// <returns></returns>
        private dynamic GetXMLStudent(AuthenticationRequest authenticationRequest)
        {
            try
            {
                var hpassword = "";
